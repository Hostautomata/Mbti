...
UVB 전구
	...
	<div id="ISTP">
			<form>
				<h2>ISTP형인 당신의 운명의 반려동물은  입니다.</h2>
				<div>
					<img alt=" 사진" src="../images/ISTP_.jpeg">
				</div>
				<p class="type_info">
...
먹이통/물통
	...
	<div id="ISFP">
			<form>
				...
				<div>
					<img alt=" 사진" src="../images/ISFP_.jpeg">
				</div>
				<p class="type_info">
...
우드펠릿
	...
	<div id="INTJ">
			<form>
				...
				<div>
					<img alt=" 사진" src="../images/INTJ_.jpeg">
				</div>
				<p class="type_info">
...
사육에 필요 물품
	...
	<div id="INFJ">
			<form>
				...
				<div>
					<img alt=" 사진" src="../images/INFJ_.jpeg">
				</div>
				<p class="type_info">
...
유목
	...
	<div id="INTP">
			<form>
				...
				<div>
					<img alt=" 사진" src="../images/INTP_.jpeg">
				</div>
				<p class="type_info">
...
밥그릇/물그릇
	...
	<div id="INFP">
			<form>
				...
				<div>
					<img alt=" 사진" src="../images/INFP_.jpeg">
				</div>
				<p class="type_info">
...
산소발생기
	...
	<div id="ESTJ">
			<form>
				...
				<div>
					<img alt=" 사진" src="../images/ESTJ_.jpeg">
				</div>
				<p class="type_info">
...
렉사 사육장
	...
	<div id="ESTP">
			<form>
				...
				<div>
					<img alt=" 사진" src="../images/ESTP_.jpeg">
				</div>
				<p class="type_info">
...
산책용 목줄
	...
	<div id="ESFP">
			<form>
				<h2>ESFP형인 당신의 운명의 반려동물은 개 입니다.</h2>
				<div>
					<img alt=" 사진" src="../images/ESFJ_.jpeg">
				</div>
				<p class="type_info">
					자존감이 높고 자기주장이 강한 당신은 ESFP형 입니다.<br>
					ESFP형인 사람은 계획적인 생활이나 고리타분한 원칙을 싫어하는 유형입니다.<br>
					에너지 넘치고 충동적인 당신에게 어울리는 반려동물은 개 입니다.<br>
					<br>
				</p>
				<hr>
				<p class="pet_info">
...
집
	...
	<div id="ESFJ">
			<form>
				...
				<div>
					<img alt=" 사진" src="../images/ESFP_.jpeg">
				</div>
				<p class="type_info">
...
스크래처
	...
	<div id="ENTJ">
			<form>
				...
				<div>
					<img alt=" 사진" src="../images/ENTJ_.jpeg">
				</div>
				<p class="type_info">
...
바닥재
				...
				<p>특정 뱀들은 동면을 하는데 이때 방치하지 마시고 매일 온도와 습도를 조절해 주셔야 합니다.</p>
			</form>
		</div>		
	<div id="ENTP">
			<form>
				...
				<div>
					<img alt=" 사진" src="../images/ENTP_.jpeg">
				</div>
				<p class="type_info">
...
데드락
	...
	<div id="ENFJ">
			<form>
				...
				<div>
					<img alt=" 사진" src="../images/ENFJ_.jpeg">
				</div>
				<p class="type_info">
...
이동식 케이지
	...
	<div id="ENFP">
			<form>
				...
				<div>
					<img alt=" 사진" src="../images/ENFP_.jpeg">
				</div>
				<p class="type_info">
